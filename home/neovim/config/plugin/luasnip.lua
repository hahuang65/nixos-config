...
map("n", "<leader>sr", [[<cmd>source $HOME/.dotfiles/nvim/lua/snippets.lua<CR>]], { desc = "[S]nippets - Reload" })

map("n", "<leader>se", require("snippets").edit_current_file_type, { desc = "[S]nippets - [E]dit current filetype)" })

map("n", "<leader>sE", require("snippets").edit_with_prompt, { desc = "[S]nippets - [E]dit prompt for filetype" })
