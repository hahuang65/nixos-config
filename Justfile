...
update:
  ...
  @just neovim-update-github
  @echo "🔄 Updating flakes..."
  nix flake update

# Add a Neovim package to home/neovim/github-packages
neovim-add-github REPO:
  ./scripts/neovim/add-github.sh {{REPO}}

# Remove a Neovim package from home/neovim/github-packages
neovim-rm-github REPO:
  ./scripts/neovim/remove-github.sh {{REPO}}

# Update GitHub packages in home/neovim/github-packages/
neovim-update-github:
  ./scripts/neovim/update-github.sh
